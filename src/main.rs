...
fn main() {
    ...
    let mut inference = nn::ProphetNetwork::from_built_model(&model);

    //nn::main();
    let mut board = Board::from_str("r2qk2r/ppp2ppp/2n2n2/2bppb2/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1").expect("invalid fen");
